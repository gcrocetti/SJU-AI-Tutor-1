...
This module implements the aggregator agent that combines responses from multiple specialized tutor
...
It's designed to:
1. Analyze responses from different tutor
...
from tutor.common.utils import setup_logging
from tutor.aggregator.prompts import SYSTEM_PROMPT
...
def aggregate_responses(
    ...
    """
    Aggregate responses from multiple tutor into a coherent, unified response.
...
""")
        ...
        logger.info(f"Successfully aggregated responses from {len(agent_responses)} tutor")
