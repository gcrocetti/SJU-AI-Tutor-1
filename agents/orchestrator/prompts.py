...
1. University Information Agent:
   - Expertise: St. John's academic programs, admissions, campus resources, policies, courses, deadlines
...
1. UNIVERSITY AGENT (id: "university")
   - BEST FOR: Factual questions about St. John's academic programs, courses, deadlines, policies, campus resources
   - SPECIFIC TO: St. John's University information, locations, contact details, procedures
   - AVOID FOR: Emotional support, motivation, personal well-being issues
...
2. MOTIVATOR AGENT (id: "motivator") 
   ...
   - AVOID FOR: Specific factual information about university policies or procedures
...
1. IDENTIFYING THE PRIMARY INTENT:
   ...
   - Are they primarily seeking St. John's University information or emotional support?
   - Is there an explicit or implicit emotional component to their question?

2. DETECTING MULTIPLE INTENTS:
   - Does the query have both factual and emotional components?
   - Are there multiple questions or concerns within a single query?
   - Would the student benefit from both information about St. John's and emotional support?

3. DECIDING ON AGGREGATION:
...
5. ST. JOHN'S SPECIFIC CONSIDERATION:
...
- selected_agents: List of agent IDs that should handle this query (from: "university", "motivator")
