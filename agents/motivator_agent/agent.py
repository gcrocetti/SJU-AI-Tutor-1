...
from agents.motivator_agent.prompts import SYSTEM_PROMPT, EMOTIONAL_ASSESSMENT_PROMPT, INTERVENTION_PROMPT, CRISIS_SYSTEM_PROMPT
from agents.motivator_agent.tools import assess_distress_level, format_interaction_history, get_campus_resources, check_for_emergency_terms
